...
const INTERESTS = [
  { icon: '🧠', title: 'Natural Language Processing', desc: 'Hate speech detection, multilingual NLP, text classification, sentiment analysis, and abstractive summarization — including fine-tuning BART for meeting minute generation and a focus on low-resource Nepali-language content.' },
    ...
    <section id="about" className="section section--alt">
      ...
      <div className="about-grid">
        ...
        >
          ...
          >
            {STATS.map(s => (
              <motion.div key={s.label} className="stat-box" variants={fadeUpItem}>
        ...
        >
          {INTERESTS.map(i => (
            <motion.div key={i.title} className="interest-item card-hover" variants={slideInRight}>
